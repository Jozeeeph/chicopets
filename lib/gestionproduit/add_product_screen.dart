...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  final TextEditingController pointsDiscountPercentController =
      TextEditingController();
  final TextEditingController maxPointsDiscountController =
      TextEditingController();
  ...
  void initState() {
    ...
    pointsEarnedController.text = '0';
    pointsCostController.text = '0';
    pointsDiscountPercentController.text = '0.0';
    maxPointsDiscountController.text = '0.0';
  ...
  void dispose() {
    ...
    pointsDiscountPercentController.dispose();
    maxPointsDiscountController.dispose();
    super.dispose();
  }
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final subCategoryName = selectedSubCategoryId != null
            ? await _sqlDb.getSubCategoryNameById(selectedSubCategoryId!)
            : '';
        ...
        final product = Product(
          ...
          pointsDiscountPercentage:
              double.tryParse(pointsDiscountPercentController.text),
              ...
              child: _buildTextFormField(
                ...
                onChanged: (value) {
                  if (value.isNotEmpty) {
                    ...
                    final discountValue = (profit * percentage) / 100;
              ...
              child: TextFormField(
                ...
                onChanged: (value) {
                  if (value.isNotEmpty) {
                    ...
                    if (profit > 0) {
                      final percentage = (discountValue / profit) * 100;
                      remiseMaxController.text = percentage.toStringAsFixed(2);
                    }
                  } else {
    ...
    return isCategoryFormVisible
        ? AddCategory(
            onCategoryAdded: () async {
              final updatedCategories = await _sqlDb.getCategories();
              setState(() {
